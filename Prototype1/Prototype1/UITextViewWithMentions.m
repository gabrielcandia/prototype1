...
static const CGFloat PORTRAIT_KEYBOARD_HEIGHT = 348; //216 Keyboard, 132 Maximum inputaccessory
...
- (void)textViewDidBeginEditing:(UITextView *)textView {
    ...
    [textView setFrame:CGRectMake(0.0, 0.0, 320.0, 50.0)];
    
    
    
    CGRect textViewRect =
    [superView.window convertRect:textView.bounds fromView:textView];
    CGRect viewRect =
    [superView.window convertRect:textView.bounds fromView:textView];
